...
<td aling="right">
<br/>
<input type="button" id="btnResumen" value="Ver completo" class="btn btn-primary" />
<td aling="left">
</td>
</tr>
</table>    
...
echo "<br>";
echo "<a href ='detalle.php?a=$titulo'<td><b><font color='red' size='4'>$titulo</font></b><br/></a>";
