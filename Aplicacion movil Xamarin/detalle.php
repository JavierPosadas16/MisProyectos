...
<td aling="right">
<br/>
<input type="button" id="btnResumen" value="Volver" class="btn-info" />
</td>
</tr>
</table>
<?php
...
<?php echo "<td><center><h3 class=titulo-chiquito> Acerca de: </h3></center>";
}
echo "<aling=justify> $reg[contenido]<br/></aling=justify>";
echo "</td>";
}
echo "</table>";
